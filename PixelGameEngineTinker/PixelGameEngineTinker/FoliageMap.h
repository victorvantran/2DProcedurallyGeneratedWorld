...
// https://ib.bioninja.com.au/options/option-c-ecology-and-conser/c2-communities-and-ecosyste/types-of-biomes.html


class FoliageMap : public PerlinNoise1D
{
private:
...
public:
	...
	FoliageMap( std::int64_t seed, std::int64_t primeX, std::int32_t octave, std::int64_t width )
