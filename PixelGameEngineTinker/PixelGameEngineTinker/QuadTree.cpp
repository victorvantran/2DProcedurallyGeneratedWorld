...
void QuadTree<TileRender>::divide()
{
	...
	*/
	...
	this->_cell[0] = TileRender( 0, BoundingBox<std::int64_t>( x, y, subWidth, subHeight ) );
	this->_cell[1] = TileRender( 0, BoundingBox<std::int64_t>( x + subWidth, y, subWidth, subHeight ) );
	this->_cell[2] = TileRender( 0, BoundingBox<std::int64_t>( x, y + subHeight, subWidth, subHeight ) );
	this->_cell[3] = TileRender( 0, BoundingBox<std::int64_t>( x + subWidth, y + subHeight, subWidth, subHeight ) );
