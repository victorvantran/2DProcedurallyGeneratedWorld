...
void Character::updateState( float deltaTime )
{
	...
	case CharacterState::Stand:
		...
		this->_animator.update( AlphaAnimator::GraphicState::Idle, this->_currVelocity.x ); // [!] animateStand
	...
	case CharacterState::Run:
		this->_animator.update( AlphaAnimator::GraphicState::Run, this->_currVelocity.x ); // [!] animateRun
		// Natural transition(s)
	...
	case CharacterState::Jump:
		this->_animator.update( AlphaAnimator::GraphicState::Jump, this->_currVelocity.x ); // [!] animateJump
		...
		// Gravity
		this->_currVelocity.y += Settings::World::GRAVITY * deltaTime; //* ( Settings::Game::TICK_RATE / Settings::World::TIME_SCALE );
